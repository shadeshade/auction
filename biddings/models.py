...
class BiddingItem(models.Model, ResizeImageMixin):
    item_name = models.CharField(max_length=150,
                                 ...
                                 blank=False,
                                 null=False)
    image = models.ImageField(null=False, blank=False, upload_to='item_images')
    ...
    auction_starts_at = models.DateTimeField(null=False, default=timezone.now, editable=True)
    auction_ends_at = models.DateTimeField(null=False, default=timezone.now, editable=True)
